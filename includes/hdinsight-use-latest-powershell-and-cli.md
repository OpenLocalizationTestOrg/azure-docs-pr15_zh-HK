> [AZURE.IMPORTANT] 支持管理使用 Azure 服务管理器 (ASM) 通过 Azure PowerShell 和 Azure CLI 的 HDInsight 资源被__否决__，并将删除由 2017 年 1 月 1。 此文档中的步骤使用新的 Azure PowerShell cmdlet 和 Azure CLI 命令的 Azure 资源管理器 (ARM)。
>

<properties
pageTitle="将 Excel 连接器添加 |Microsoft Azure"
description="与 REST API，参数的 Excel 连接器的概述"
services=""    
documentationCenter=""     
authors="msftman"    
manager="erikre"    
...
# <a name="get-started-with-the-excel-connector"></a>开始使用 Excel 连接器

目前，在应用程序逻辑中没有 Excel 接头。 

## <a name="to-use-excel-data"></a>若要使用 Excel 数据
可以将 Excel 数据存储为存储文件夹，如[OneDrive](connectors-create-api-onedrive.md)中的逗号分隔值 (CSV) 文件。 您还可以使用[平面文件连接器](../app-service-logic/app-service-logic-enterprise-integration-flatfile.md)使用此 CSV 文件。

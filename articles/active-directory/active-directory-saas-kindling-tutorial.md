...
若要配置单一登录的 Kindling，您需要注册的域。 如果您还没有注册的域，请联系 Kindling 的支持团队通过[support@kindlingapp.com](mailto:support@kindlingapp.com)。  
...
本节的目的是创建一个名 Britta Simon Kindling 中的用户。

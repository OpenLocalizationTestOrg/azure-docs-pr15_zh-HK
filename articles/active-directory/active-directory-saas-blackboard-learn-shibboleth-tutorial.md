...
在本节中，您 Azure AD single sign-on 等传统门户中启用并配置单一登录您黑板式学习的 Shibboleth 应用程序中。
...
在本节中，您创建一个在黑板式学习的 Shibboleth 名 Britta Simon 的用户。 请使用 Blackboard 了解同伴在黑板式学习-Shibboleth 平台添加用户。

...
在本节中，您 Azure AD single sign-on 等传统门户中启用并配置单一登录，FieldGlass 应用程序中。
...
这一节的目标是创建一个用户，在 FieldGlass.Please 与 FieldGlass 的支持团队的工作称为 Britta Simon FieldGlass 帐户中添加用户。

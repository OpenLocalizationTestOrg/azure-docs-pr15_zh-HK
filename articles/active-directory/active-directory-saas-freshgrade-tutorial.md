...
**以 FreshGrade Azure AD 单一登录配置，请执行以下步骤︰**
...
3. 若要显示列表的用户，在顶部菜单中，单击**用户**。
    ...
    ![Azure 广告测试用户](./media/active-directory-saas-freshgrade-tutorial/create_aaduser_03.png) 
...
**若要分配 Britta Simon FreshGrade，请执行以下步骤︰**

...
黑板式学习应用程序需要以特定格式的 SAML 断言。 请配置该应用程序的以下声明。 您可以从应用程序的**"Atrribute"**选项卡上管理这些属性的值。 下面的屏幕快照显示此示例。 
...
7. 在**获得临时密码**对话框页面上，单击**创建**。
    ...
    ![Azure 广告测试用户](./media/active-directory-saas-blackboard-learn-tutorial/create_aaduser_07.png) 

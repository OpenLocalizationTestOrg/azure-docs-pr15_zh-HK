...
# <a name="provision-a-web-app-with-a-sql-database"></a>设置 web 应用程序与 SQL 数据库
...
[![将部署到 Azure](./media/app-service-web-arm-with-sql-database-provision/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2F201-web-app-sql-database%2Fazuredeploy.json)

## <a name="parameters-to-specify"></a>若要指定的参数
...
## <a name="variables-for-names"></a>变量的名称

此模板包括构造模板中使用的名称的变量。 变量的值使用**uniqueString**函数来生成一个名称，从资源组 id。
...
### <a name="alert-rules-for-status-codes-403-and-500s-high-cpu-and-http-queue-length"></a>状态代码 403 和 500's，高 CPU 和 HTTP 队列长度的预警规则 
